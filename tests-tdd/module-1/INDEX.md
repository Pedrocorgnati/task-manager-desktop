...
RED baseline: 72 testes / 72 red / 0 green_leaked / 0 environmental
...
| TID-1-1-006 | acceptance | `tests-tdd/module-1/acceptance/test_us001_create.py::test_create_with_offline_type` | TASK-1/ST001 — US-001#6 | RED |
| TID-1-1-007 | acceptance | `tests-tdd/module-1/acceptance/test_us001_create.py::test_create_with_explicit_projeto` | TASK-1/ST001 — US-001#7 | RED |
| TID-1-1-008 | acceptance | `tests-tdd/module-1/acceptance/test_us001_create.py::test_empty_projeto_normalized_to_outros` | TASK-1/ST001 — US-001#8 | RED |
...
| TID-1-1-012 | unit | `tests-tdd/module-1/unit/ui/dialogs/test_new_task_dialog.py::test_get_data_normalizes_projeto_and_parses_deps` | TASK-1/ST001 — TASK-1/ST001 get_data() | RED |
...
| TID-1-1-021 | unit | `tests-tdd/module-1/unit/ui/test_task_card_placeholder.py::test_placeholder_renders_id_titulo_status_type_projeto` | TASK-1/ST004 — TASK-1/ST004 placeholder | RED |
...
| TID-1-2-006 | acceptance | `tests-tdd/module-1/acceptance/test_us002_edit.py::test_rename_projeto_emits_projects_changed` | TASK-2/ST003 — US-002#6 | RED |
| TID-1-2-007 | acceptance | `tests-tdd/module-1/acceptance/test_us002_edit.py::test_empty_projeto_normalizes_to_outros` | TASK-2/ST001 — US-002#7 | RED |
...
| TID-1-2-016 | unit | `tests-tdd/module-1/unit/ui/test_task_card.py::test_title_and_projeto_labels_use_plain_text_format` | TASK-2/ST002 — TASK-2/ST002 anti-XSS | RED |
...
| TID-1-2-019 | unit | `tests-tdd/module-1/unit/repositories/test_task_repository.py::test_update_applies_four_fields_via_bind_where_id` | TASK-2/ST003 — TASK-2/ST003 update | RED |
...
| TID-1-2-022 | contract | `tests/contracts/test_edit_task_controller_contract.py::test_edit_task_controller_projects_changed_is_signal_no_args` | TASK-2/ST003 — OVERVIEW.md/Contratos | RED |
...
| TID-1-2-025 | integration | `tests/integration/test_edit_task_controller.py::test_edit_task_controller_emits_projects_changed_only_when_projeto_changes` | TASK-2/ST003 — TASK-2/ST003 projects_changed | RED |
...
| TID-1-3-015 | unit | `tests-tdd/module-1/unit/repositories/test_task_repository.py::test_list_projetos_distinct_excludes_hidden_orders_case_insensitive` | TASK-3/ST001 — TASK-3/ST001 list_projetos | RED |
...
| TID-1-3-017 | contract | `tests/contracts/test_task_repository_contract.py::test_task_repository_facade_exposes_nine_public_methods` | TASK-3/ST001 — OVERVIEW.md/Contratos facade | RED |
